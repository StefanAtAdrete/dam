 ...
 * )
 */
class ImageContectualUrlFormatter extends ImageUrlFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($images as $delta => $image) {
      ...
      if ($use_case_plugin != NULL) {
        $image_uri = $use_case_plugin->getContextualUri($item, $image_uri, $image_style->id());
      }
