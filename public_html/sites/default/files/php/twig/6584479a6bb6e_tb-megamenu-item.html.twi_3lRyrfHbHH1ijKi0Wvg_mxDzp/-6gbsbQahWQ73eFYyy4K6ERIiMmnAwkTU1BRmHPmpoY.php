...
class __TwigTemplate_c7e29c3854e29658a7c4d54bdbcc736d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["link"] ?? null), "url", [], "array", true, true, true, 2) &&  !twig_test_empty((($__internal_compile_1 = ($context["link"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["url"] ?? null) : null)))) {
            ...
            if (twig_test_empty(($context["submenu"] ?? null))) {
                // line 7
                echo "    ";
                $context["linkAttributes"] = twig_get_attribute($this->env, $this->source, ($context["linkAttributes"] ?? null), "addClass", ["tbm-no-submenu"], "method", false, false, true, 7);
                // line 8
                echo "  ";
            }
        }
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["link", "submenu", "attributes", "section", "fontawesome", "item_config", "group", "block_config"]);    }
