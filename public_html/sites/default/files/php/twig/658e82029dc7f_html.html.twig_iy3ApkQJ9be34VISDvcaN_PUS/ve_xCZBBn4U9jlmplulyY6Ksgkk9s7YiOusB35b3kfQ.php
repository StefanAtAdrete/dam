...
class __TwigTemplate_495aba1ede79b32f057e65c189d9ef66 extends Template
{
    private $source;
    private $macros = [];
...
<html";
        // line 39
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["html_attributes"] ?? null), "addClass", [""], "method", false, false, true, 39), 39, $this->source), "html", null, true);
        echo ">
\t<head>
